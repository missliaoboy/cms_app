...
<div id="table-lists" class="table-list" >
    <table height="auto" cellspacing="0" >
		...
		foreach($batch_array as $catid=>$cat) {
			...
			$batch_array[$catid]['msetting'] = string2array($cat['msetting']);
	...
	?>
		...
		<?php echo form::select($template_list, $cat['setting']['template_list'], 'name="msetting['.$catid.'][template_list]" id="template_list" onchange="load_file_list(this.value,'.$catid.')"', L('please_select'))?> 
		</td>
	<?php
		}
	?>
	...
	?>
		...
		<?php echo form::select_template($cat['setting']['template_list'], 'content',$cat['msetting']['category_template_app'],'name="msetting['.$catid.'][category_template_app]" style="width:250px"','category');?>
		</div>
		</td>
	<?php
		}
	...
	?>
		...
		<?php echo form::select_template($cat['setting']['template_list'], 'content',$cat['msetting']['list_template_app'],'name="msetting['.$catid.'][list_template_app]" style="width:250px"','list');?>
		</div>
		</td>
	<?php
		}
	...
	?>
		...
		<?php echo form::select_template($cat['setting']['template_list'], 'content',$cat['msetting']['show_template_app'],'name="msetting['.$catid.'][show_template_app]" style="width:250px"','show');?>
		</div>
		</td>
	<?php
		}
