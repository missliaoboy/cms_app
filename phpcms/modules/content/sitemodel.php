...
class sitemodel extends admin {
	...
	public function add() {
		if(isset($_POST['dosubmit'])) {
			...
			$_POST['info']['category_template_app'] = $_POST['setting']['category_template_app'];
			$_POST['info']['list_template_app'] = $_POST['setting']['list_template_app'];
			$_POST['info']['show_template_app'] = $_POST['setting']['show_template_app'];
	...
	function import(){
		if(isset($_POST['dosubmit'])) {
			...
			$info['category_template_app'] = $_POST['setting']['category_template_app'];
			$info['list_template_app'] = $_POST['setting']['list_template_app'];
			$info['show_template_app'] = $_POST['setting']['show_template_app'];
